...
if __name__ == '__main__':
    ...
    process('valid_data_dbpedia.jsonl', 'valid_data_processed_user.jsonl', movie_set)
    process('test_data_dbpedia.jsonl', 'test_data_processed_user.jsonl', movie_set)
    process('train_data_dbpedia.jsonl', 'train_data_processed_user.jsonl', movie_set)
