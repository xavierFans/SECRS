...
class CRSRecDataset(Dataset):
    def __init__(
        ...
        # 这是merge template后的数据，用生成的template代替coworker的回复
    ...
    def prepare_data(self, data_file):
        # 读取user_embeds
        # user_embeds = torch.load('./data/redial/KG_embs_top5.pt')
        # user_embeds = torch.load('./data/redial/KG_embs_best_top5.pt')
        user_embeds = torch.load('./data/redial/KG_embs_best_top100.pt')
        # user_embeds = torch.load('./data/redial/kg_user_top10.pt')
        # user_embeds = torch.load('./data/redial/kg_user_top5.pt')
