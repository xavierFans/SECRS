...
class EntityKG:
    def __init__(self, dataset, debug=False):
        ...
        # 在此处替换
        with open(os.path.join(self.dataset_dir, 'entity_kg_10items_noself.json'), 'r', encoding='utf-8') as f:
            self.entity_kg = json.load(f)
        with open(os.path.join(self.dataset_dir, 'entity2id.json'), 'r', encoding='utf-8') as f:
            self.entity2id = json.load(f)
        with open(os.path.join(self.dataset_dir, 'entitykg_relation2id.json'), 'r', encoding='utf-8') as f:
